...
/* Menampilkan Buku */
/* OLD CODE SEBELUM PENGERJAAN OPTIONAL 

const getAllBookByIdHandler = () => ({
  status: "success",
  data: {
    // Gunakan Map untuk mengambil beberapa property saja
